...
#debugLog{position:fixed;bottom:0;left:0;right:0;background:#1a1a1a;color:#0f0;font-size:11px;font-family:monospace;padding:8px;max-height:120px;overflow-y:auto;white-space:pre-wrap;word-break:break-all;z-index:9999}
</style>
</head>
<body>
<div class="container">
...
<table>
<thead><tr><th class="checkbox-cell"><input type="checkbox" id="checkAll" checked></th><th>表名</th></tr></thead>
...
(function() {
  ...
  function renderTableList(tables) {
    ...
    tables.forEach(function(t) {
      ...
      tr.innerHTML = '<td class="checkbox-cell"><input type="checkbox" class="table-checkbox" value="' + t.name + '" checked></td><td>' + t.name + '</td>';
